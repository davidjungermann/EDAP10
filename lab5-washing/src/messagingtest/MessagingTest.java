...
class MessagingTest {
  ...
  void testBidirectional() throws InterruptedException {
    checkMainPrints(ExampleBidirectional::main, "request sent by ClientThread\n"
  ...
  void testProducerConsumer() throws InterruptedException {
    checkMainPrints(ExampleProducerConsumer::main, "consumer eagerly awaiting messages...\n" + "received [ole]\n"
        + "received [dole]\n" + "received [doff]\n" + "all done\n");
  }

  @Test
  void testMessagingWithTimeout() throws InterruptedException {
    checkMainPrints(ExampleMessagingWithTimeout::main, "consumer eagerly awaiting messages...\n" + "received [ole]\n"
        + "received [dole]\n" + "received [null]\n" + "received [doff]\n" + "all done\n");
  }
  ...
  /**
   * Helper interface for making lambdas, for a main function that throws
  ...
  /**
   * Helper method: run a main method in another class, and check the printed
   * output.
   */
